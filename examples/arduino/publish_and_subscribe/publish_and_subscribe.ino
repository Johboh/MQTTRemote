...
MQTTRemote::Configuration configuration = {.buffer_size = 2048, .keep_alive_s = 10, .receive_verbose = true};
MQTTRemote _mqtt_remote(mqtt_client_id, mqtt_host, 1883, mqtt_username, mqtt_password, configuration);
